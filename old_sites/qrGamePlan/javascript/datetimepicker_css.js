...
var WeekHeadColor = "#0099CC"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#6699FF"; //var SundayColor="#C0F64F";//Background color of Sunday.
...
var HoverColor = "#ffff33"; //color when mouse move over.
